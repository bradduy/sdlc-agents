...
account that has Confluence access.

Some Atlassian organizations restrict external tools, Rovo/MCP access, or IP ranges.
If auth succeeds but Confluence data is unavailable, confirm the selected Atlassian
